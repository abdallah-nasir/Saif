# Generated by Django 3.0.7 on 2021-06-13 20:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Tech_Parts.Category')),
                ('processor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Tech_Parts.Processor')),
                ('type', models.ForeignKey(default=6, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Tech_Parts.Type')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('supplier', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='Tech_Parts.Supplier')),
            ],
        ),
        migrations.CreateModel(
            name='Filters',
